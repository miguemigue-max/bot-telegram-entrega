    ...
    if request.method == "POST":
        ...
        send_email(
            ...
            email_layout(
                ...
                <p>Desde ahora puedes usar tus wallets, transferencias, depósitos, retiros y conversiones dentro de XyPher.</p>
                """
            )
        )
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  startBtn.addEventListener("click", async function () {
    try {
      ...
      messageEl.textContent = "No se pudo abrir la cámara. Revisa permisos de Safari.";
...
def approve_deposit(deposit_id):
    ...
    if target_user:
        send_email(
            target_user["email"],
            "Depósito aprobado",
            f"Tu depósito de {deposit_amount:.2f} {deposit_currency} fue aprobado y convertido a {usd_amount:.2f} USD en tu cuenta."
        )
